...
This plugin integrates the CoffeeBreak core with an external point system service, providing functionality for managing user points, leaderboards, and transaction history.
